...
- **Clawd AI Test Suite**: 68 automated tests in `server/services/clawd/clawd.test.ts`. Covers SMS classification accuracy, entity extraction, orchestrator routing, Discord payload format, and edge cases. Run with: `npx tsx server/services/clawd/clawd.test.ts`.
